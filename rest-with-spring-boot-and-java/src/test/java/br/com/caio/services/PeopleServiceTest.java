...
class PersonServicesTest {
    ...
    void findById() {
        ...
        assertNotNull(result.getLinks());//hatteoas
    ...
    void delete() {
        ...
        verify(repository, times(1)).delete(any(People.class));
    ...
    void findAll() {
        ...
        List<PeopleDTO> people = service.findAll();
